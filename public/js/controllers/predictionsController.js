...
predictionsApp.controller('agenciesController',
    function agenciesController($scope, $http, fetchRestbusDataFactory) {
...
predictionsApp.controller('routesController',
    function routesController($scope, $http, $routeParams, fetchRestbusDataFactory) {
        $scope.data_loading = true;
...
predictionsApp.controller('stopsController',
    function stopsController($scope, $http, $routeParams, fetchRestbusDataFactory) {
        $scope.agency_id = $routeParams.agency_id;
...
predictionsApp.controller('predictionsController',
    function predictionsController($scope, $http, $routeParams, fetchRestbusDataFactory) {
        $scope.agency_id = $routeParams.agency_id;
        $scope.route_id = $routeParams.route_id;
        $scope.route_title = '';
